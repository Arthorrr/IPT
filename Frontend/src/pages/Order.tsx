...
<div className="w-full h-14 p-8 items-center flex justify-center">
  <button className="bg-blue-500 hover:bg-blue-700 text-black font-bold py-3 px-4 rounded">
              ...
              <tr key={orders.orderNumber}>
                ...
                <td>
                  <button
                    ...
                    className="mr-4 bg-blue-400 hover:bg-blue-600 duration-300 transition-all ease-in-out text-white font-bold py-200 px-4 rounded"
                  >
                    &#9998;
                  </button>
                  <button
                    ...
                    className="bg-red-400 hover:bg-red-600 duration-300 transition-all ease-in-out text-white font-bold py-200 px-4 rounded"
                  >
                    &times;
                  </button>
                </td>
